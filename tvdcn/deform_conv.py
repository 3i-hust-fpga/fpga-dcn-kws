...
def deform_conv1d(input, weight, offset, mask=None, bias=None, stride=1, padding=0, dilation=1):
    # type: (Tensor, Tensor, Tensor, Optional[Tensor], Optional[Tensor], Tuple[int, ...], Tuple[int, ...], Tuple[int, ...]) -> Tensor
    """
...
def deform_conv2d(input, weight, offset, mask=None, bias=None, stride=(1, 1), padding=(0, 0), dilation=(1, 1)):
    # type: (Tensor, Tensor, Tensor, Optional[Tensor], Optional[Tensor], Tuple[int, ...], Tuple[int, ...], Tuple[int, ...]) -> Tensor
    """
    Performs Deformable Convolution, described in Deformable Convolutional Networks
    Arguments:
    ...
    # print('dit me torchvision', torch.__version__, torchvision.__version__)
...
def deform_conv3d(input, weight, offset, mask=None, bias=None, stride=(1, 1, 1), padding=(0, 0, 0), dilation=(1, 1, 1)):
    # type: (Tensor, Tensor, Tensor, Optional[Tensor], Optional[Tensor], Tuple[int, ...], Tuple[int, ...], Tuple[int, ...]) -> Tensor
    """
    Performs 3D version of Deformable Convolution described in Deformable Convolutional Networks
    Arguments:
...
class DeformConv1d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0,
                 dilation=1, groups=1, bias=True, modulated=False):
...
class DeformConv2d(nn.Module):
    ...
    def forward(self, input):
        ...
        # return deform_conv2d(input, self.weight, offset, mask, self.bias, stride=self.stride,
                             # padding=self.padding, dilation=self.dilation), offset
        return deform_conv2d(input, self.weight, offset, mask, self.bias, stride=self.stride,
                             padding=self.padding, dilation=self.dilation), offset, self.weight, self.bias
